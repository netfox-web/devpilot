...
UI_TRANSLATIONS["zh-Hant"].update({
    # Legacy project detail and operational pages.
    "Project Overview": "專案總覽",
    "Engineering Report": "工程報告",
    "Export MD": "匯出 MD",
    "Edit Project": "編輯專案",
    "Delete": "刪除",
    "Legacy operational controls are present on this project page.": "此專案頁仍包含舊版操作控制項。",
    "Review carefully before use. Production-impacting actions require a separate approval phase. This page is distinct from the read-only safety dashboards.": "使用前請仔細確認。會影響 production 的操作需要獨立核准階段；本頁不同於唯讀安全儀表板。",
    "Existing operational controls below": "下方包含既有操作控制",
    "Review carefully before use": "使用前請仔細確認",
    "Production-impacting actions require separate approval": "影響 production 的操作需要另行核准",
    "API quick info": "API 快速資訊",
    "Secure auth header required. The credential value is intentionally hidden on this page.": "需要安全驗證標頭；本頁刻意隱藏憑證值。",
    "Domain / Preview": "網域 / 預覽",
    "Domain Center": "網域中心",
    "Purpose": "用途",
    "Base domain": "基礎網域",
    "Environment": "環境",
    "Generate Preview DNS Plan": "產生預覽 DNS 計畫",
    "Plan only.": "僅規劃。",
    "Domain": "網域",
    "Type": "類型",
    "Preview URL": "預覽 URL",
    "Notes": "備註",
    "No domain mappings yet.": "尚無網域對應。",
    "AI Tasks": "AI 任務",
    "project task flow": "專案任務流程",
    "Task Templates": "任務範本",
    "New AI Task": "新增 AI 任務",
    "Task Type": "任務類型",
    "Priority": "優先級",
    "Title": "標題",
    "Order": "順序",
    "Provider": "供應商",
    "Prompt": "提示詞",
    "No task templates yet.": "尚無任務範本。",
    "Global Flow Runs": "全域流程執行紀錄",
    "AI Flow Runs": "AI 流程執行紀錄",
    "Dispatch Jobs": "派工任務",
    "Operational Controls": "操作控制",
    "Use only inside an authorized deployment phase. Read-only dashboards never trigger these actions.": "僅可在已授權的部署階段使用；唯讀儀表板不會觸發這些操作。",
    "Create default AI flow": "建立預設 AI 流程",
    "Run safe AI flow": "執行安全 AI 流程",
    "Run full AI flow": "執行完整 AI 流程",
    "Flow mode result": "流程模式結果",
    "Production requires approval": "Production 需要核准",
    # Cloudflare settings.
    "Cloudflare Settings": "Cloudflare 設定",
    "Cloudflare credentials are encrypted in the API Key Center and shown as masked values only.": "Cloudflare 憑證會在 API Key Center 加密保存，頁面只顯示遮罩值。",
    "MASKED VALUES ONLY": "僅顯示遮罩值",
    "READ-ONLY ZONE DATA": "唯讀 Zone 資料",
    "API key management area.": "API 金鑰管理區。",
    "Do not paste credential values into screenshots or chat. DNS write remains disabled unless a separate approved phase enables it.": "請勿把憑證值貼到截圖或聊天中。除非另有核准階段啟用，DNS 寫入維持停用。",
    "Save Cloudflare Credential": "儲存 Cloudflare 憑證",
    "Credential value": "憑證值",
    "Version": "版本",
    "Rotation days": "輪替天數",
    "Encrypt and save credential": "加密並儲存憑證",
    "Cloudflare Credentials": "Cloudflare 憑證",
    "Load zones": "載入 zones",
    "Env": "環境",
    "Masked": "遮罩",
    "Updated": "更新時間",
    "No Cloudflare credential yet": "尚無 Cloudflare 憑證",
    "Cloudflare DNS Write Gate": "Cloudflare DNS 寫入閘門",
    "Feature flag": "功能旗標",
    "Effective": "實際狀態",
    "UI toggle": "UI 切換",
    "Not available": "不可用",
    "Execute endpoint": "執行端點",
    "Feature-flag gated": "受功能旗標控管",
    "Zones": "Zones",
    "Ready.": "就緒。",
    "Load zones to begin.": "載入 zones 後開始。",
    "DNS Records": "DNS Records",
    "Zone ID": "Zone ID",
    "Any": "任意",
    "Name filter": "名稱篩選",
    "Load DNS records": "載入 DNS records",
    "Select a zone and load DNS records.": "選擇 zone 並載入 DNS records。",
    "Test": "測試",
    # Domain center.
    "Domain Center / 網域管理中心": "網域中心",
    "Read-only Cloudflare zone and DNS overview. DNS changes are not available in this MVP.": "唯讀 Cloudflare zone 與 DNS 總覽；此 MVP 不提供 DNS 變更。",
    "PLAN ONLY": "僅規劃",
    "Legacy/manual domain binding controls are present below.": "下方包含舊版 / 人工網域綁定控制項。",
    "Verify the DNS safety gate before any domain mapping change. This page still does not perform Cloudflare DNS writes.": "變更任何網域對應前請確認 DNS 安全閘門；本頁仍不執行 Cloudflare DNS 寫入。",
    "Domain Center is not available": "網域中心目前不可用",
    "Cloudflare read-only data could not be loaded.": "無法載入 Cloudflare 唯讀資料。",
    "Read Mode": "讀取模式",
    "Read-only": "唯讀",
    "DNS Write API": "DNS 寫入 API",
    "Disabled": "停用",
    "Preview Domain Plan": "預覽網域計畫",
    "plan only": "僅規劃",
    "Project": "專案",
    "Select project": "選擇專案",
    "Generate Plan": "產生計畫",
    "No preview DNS plan generated yet. This does not change Cloudflare DNS.": "尚未產生預覽 DNS 計畫；這不會變更 Cloudflare DNS。",
    "Records": "Records",
    "Root A": "Root A",
    "www CNAME": "www CNAME",
    "A Records": "A Records",
    ...
    "Bind": "綁定",
    "DNS Status": "DNS 狀態",
    "Reverse Proxy Status": "Reverse Proxy 狀態",
    "No DNS records returned.": "未回傳 DNS records。",
    "No DNS write was performed.": "未執行 DNS 寫入。",
    # Approval requests.
    "High-risk action approvals. This MVP only changes approval status; it does not write DNS or deploy.": "高風險操作核准；此 MVP 只變更核准狀態，不寫 DNS、不部署。",
    "Controlled notification testing area.": "受控通知測試區。",
    "Use test sends only inside an authorized QA phase. Real DNS/deploy approval flows require explicit phase authorization.": "測試送出只能在已授權 QA 階段使用；真實 DNS / deploy 核准流程需要明確階段授權。",
    "Request Type": "請求類型",
    "Project ID": "專案 ID",
    "Filter": "篩選",
    "Requests": "請求",
    ...
    "Summary": "摘要",
    "Payload": "Payload",
    "Telegram Mock": "Telegram 模擬",
    "Created / Updated": "建立 / 更新",
    "Approved / Rejected": "核准 / 拒絕",
    "Controlled Test Send": "受控測試送出",
    "Mock Notification": "模擬通知",
    "Controlled testing only": "僅限受控測試",
    "Execute disabled": "執行已停用",
    "Rollback draft: available": "Rollback 草稿：可用",
    "Final phrase required": "需要最終確認句",
    "No approval requests.": "沒有核准請求。",
    "All": "全部",
    "Expired": "已過期",
    # AI Console and sandbox.
    "Provider health, AI task dispatch, ai_messages results.": "供應商健康、AI 任務派工與 ai_messages 結果。",
    "Sandbox Gallery": "Sandbox 產物庫",
    "AI Providers": "AI 供應商",
    "Retest": "重新測試",
    "Not tested": "尚未測試",
    "OpenAI GPT health check": "OpenAI GPT 健康檢查",
    "Gemini health check": "Gemini 健康檢查",
    "Pending": "待處理",
    "Claude field is reserved for now.": "Claude 欄位目前保留。",
    "API keys are never displayed here.": "本頁永不顯示 API 金鑰。",
    "Claude Executor Preview": "Claude 執行器預覽",
    "Preview only / Sandbox optional / No deploy / No DNS": "僅預覽 / 可選 Sandbox / 不部署 / 不改 DNS",
    "This preview calls the selected AI provider and returns text or HTML. Sandbox mode can write one gated HTML artifact to the AI Console sandbox only. It never writes project files, deploys, restarts services, calls DNS, or sends Telegram messages.": "此預覽會呼叫選定 AI 供應商並回傳文字或 HTML。Sandbox 模式只會在通過閘門後寫入一個 AI Console sandbox HTML 產物；不寫入專案檔案、不部署、不重啟服務、不呼叫 DNS、不傳送 Telegram。",
    "Executor": "執行器",
    ...
    "Output mode": "輸出模式",
    "Preview only": "僅預覽",
    "Sandbox HTML artifact": "Sandbox HTML 產物",
    "Sandbox writes require complete HTML plus Gemini PASS.": "Sandbox 寫入需要完整 HTML 且 Gemini PASS。",
    "Ask Claude to return text or a single-file HTML preview only.": "請要求 Claude 只回傳文字或單檔 HTML 預覽。",
    "Run preview": "執行預覽",
    "No preview run yet.": "尚未執行預覽。",
    "Executor output": "執行器輸出",
    "Reviewer output": "審查者輸出",
    "Sandbox Output": "Sandbox 輸出",
    "No file write": "不寫檔",
    "No deploy": "不部署",
    "No DNS": "不改 DNS",
    "Sandbox artifact created": "Sandbox 產物已建立",
    "AI Console Sandbox Gallery": "AI 控制台 Sandbox 產物庫",
    "Recent HTML artifacts generated by AI Console sandbox mode.": "AI Console sandbox 模式近期產生的 HTML 產物。",
    "No delete / No deploy / No project write": "不刪除 / 不部署 / 不寫入專案",
    "Artifact": "產物",
    "Size": "大小",
    "Age": "年齡",
    "Retention": "保留",
    "Recommended action": "建議動作",
    "Sandbox directory could not be read:": "無法讀取 Sandbox 目錄：",
    "Sandbox directory has not been created yet.": "Sandbox 目錄尚未建立。",
    # Release and safety dashboards.
    "This page is read-only. It has no restore, delete, rollback, deploy, DNS execute, restart, or feature-flag toggle controls.": "本頁為唯讀；沒有 restore、delete、rollback、deploy、DNS execute、restart 或 feature-flag toggle 控制。",
    "Open Release Note": "開啟發佈備註",
    "Open Release Dashboard": "開啟發佈儀表板",
    "Review approval requests": "檢視核准請求",
    "BACKUPS READ-ONLY": "備份唯讀",
    "READ-ONLY FREEZE": "唯讀封版",
    "Git tag": "Git tag",
    "not created": "未建立",
    "login protected": "登入保護",
    "No backups visible from runtime.": "runtime 目前看不到備份。",
    "Manual only": "僅人工",
    "Manual only. No action is executed from this page.": "僅供人工參考；本頁不執行任何操作。",
    "Read-only planning board generated from the Domain / Reverse Proxy Readiness results.": "由網域 / Reverse Proxy 就緒結果產生的唯讀規劃看板。",
    "Read-only Guardrails": "唯讀護欄",
    "Read-only DNS, HTTP, HTTPS, TLS, backend, and reverse proxy status for DevPilot and Aichat hostnames.": "DevPilot 與 Aichat hostnames 的 DNS、HTTP、HTTPS、TLS、後端與 Reverse Proxy 唯讀狀態。",
    "Read-only production status, backup inventory, approval state, and DNS audit trail.": "唯讀 production 狀態、備份清單、核准狀態與 DNS 稽核軌跡。",
    "Backup Summary": "備份摘要",
    "DB Safety Snapshot": "DB 安全快照",
    "DNS Audit Snapshot": "DNS 稽核快照",
    "Recent Approval Snapshot": "近期核准快照",
    "Safety Flags": "安全旗標",
    "Links": "連結",
})
UI_TRANSLATIONS["en"].update({
    "專案總覽": "Project Overview",
    "工程報告": "Engineering Report",
    "匯出 MD": "Export MD",
    "編輯專案": "Edit Project",
    "刪除": "Delete",
    "網域中心": "Domain Center",
    ...
    "基礎網域": "Base domain",
    "環境": "Environment",
    "產生預覽 DNS 計畫": "Generate Preview DNS Plan",
    "僅規劃。": "Plan only.",
    "網域": "Domain",
    "類型": "Type",
    "預覽 URL": "Preview URL",
    "備註": "Notes",
    "AI 任務": "AI Tasks",
    "專案任務流程": "project task flow",
    "任務範本": "Task Templates",
    "新增 AI 任務": "New AI Task",
    "任務類型": "Task Type",
    "優先級": "Priority",
    "標題": "Title",
    "順序": "Order",
    ...
    "Cloudflare 設定": "Cloudflare Settings",
    "僅顯示遮罩值": "MASKED VALUES ONLY",
    "唯讀 Zone 資料": "READ-ONLY ZONE DATA",
    "API 金鑰管理區。": "API key management area.",
    "儲存 Cloudflare 憑證": "Save Cloudflare Credential",
    "憑證值": "Credential value",
    "版本": "Version",
    "輪替天數": "Rotation days",
    "加密並儲存憑證": "Encrypt and save credential",
    "Cloudflare 憑證": "Cloudflare Credentials",
    "載入 zones": "Load zones",
    "遮罩": "Masked",
    "更新時間": "Updated",
    "Cloudflare DNS 寫入閘門": "Cloudflare DNS Write Gate",
    "功能旗標": "Feature flag",
    "實際狀態": "Effective",
    "UI 切換": "UI toggle",
    "不可用": "Not available",
    "執行端點": "Execute endpoint",
    "受功能旗標控管": "Feature-flag gated",
    "就緒。": "Ready.",
    "名稱篩選": "Name filter",
    "載入 DNS records": "Load DNS records",
    "測試": "Test",
    "網域中心": "Domain Center",
    "僅規劃": "PLAN ONLY",
    "讀取模式": "Read Mode",
    "停用": "Disabled",
    "預覽網域計畫": "Preview Domain Plan",
    "選擇專案": "Select project",
    "產生計畫": "Generate Plan",
    "內容": "Content",
    "綁定": "Bind",
    "DNS 狀態": "DNS Status",
    "Reverse Proxy 狀態": "Reverse Proxy Status",
    "高風險操作核准；此 MVP 只變更核准狀態，不寫 DNS、不部署。": "High-risk action approvals. This MVP only changes approval status; it does not write DNS or deploy.",
    "受控通知測試區。": "Controlled notification testing area.",
    "請求類型": "Request Type",
    "專案 ID": "Project ID",
    "篩選": "Filter",
    "請求": "Requests",
    "執行": "Execution",
    "摘要": "Summary",
    "建立 / 更新": "Created / Updated",
    "核准 / 拒絕": "Approved / Rejected",
    "受控測試送出": "Controlled Test Send",
    "模擬通知": "Mock Notification",
    "僅限受控測試": "Controlled testing only",
    "執行已停用": "Execute disabled",
    "全部": "All",
    "已過期": "Expired",
    "AI 供應商": "AI Providers",
    "重新測試": "Retest",
    "尚未測試": "Not tested",
    "待處理": "Pending",
    "Claude 執行器預覽": "Claude Executor Preview",
    "執行器": "Executor",
    ...
    "輸出模式": "Output mode",
    "僅預覽": "Preview only",
    "Sandbox HTML 產物": "Sandbox HTML artifact",
    "執行預覽": "Run preview",
    "執行器輸出": "Executor output",
    "審查者輸出": "Reviewer output",
    "不寫檔": "No file write",
    "不部署": "No deploy",
    "不改 DNS": "No DNS",
    "Sandbox 輸出": "Sandbox Output",
    "Sandbox 產物已建立": "Sandbox artifact created",
    "不刪除 / 不部署 / 不寫入專案": "No delete / No deploy / No project write",
    "產物": "Artifact",
    "大小": "Size",
    "年齡": "Age",
    "保留": "Retention",
    "建議動作": "Recommended action",
    "開啟發佈備註": "Open Release Note",
    "開啟發佈儀表板": "Open Release Dashboard",
    "檢視核准請求": "Review approval requests",
    "備份唯讀": "BACKUPS READ-ONLY",
    "唯讀封版": "READ-ONLY FREEZE",
    "未建立": "not created",
    "登入保護": "login protected",
    "僅人工": "Manual only",
    "備份摘要": "Backup Summary",
    "DB 安全快照": "DB Safety Snapshot",
    "DNS 稽核快照": "DNS Audit Snapshot",
    "近期核准快照": "Recent Approval Snapshot",
    "安全旗標": "Safety Flags",
    "連結": "Links",
})
UI_TRANSLATIONS["zh-Hant"].update({
    # Phase 79 P1/P2 coverage: domain action plan.
    "Ready / Monitor": "就緒 / 監控",
    "SSL / Certificate Needed": "需要 SSL / 憑證",
    "Backend / Upstream Pending": "後端 / upstream 待確認",
    "DNS Missing / Future Create": "DNS 缺失 / 未來建立",
    "High-risk / Do Not Touch First": "高風險 / 暫勿優先變更",
    "Next phase suggestion": "下一階段建議",
    "Future manual confirmation phrase draft": "未來人工確認句草稿",
    "Current status: ready": "目前狀態：就緒",
    "Current status: backend unconfigured": "目前狀態：後端未設定",
    "Current status: dns missing": "目前狀態：DNS 缺失",
    "DNS record is missing.": "DNS record 缺失。",
    "Keep monitoring. No DNS or NAS change is needed.": "持續監控；不需要 DNS 或 NAS 變更。",
    "Periodic HTTP/HTTPS health check": "定期 HTTP/HTTPS 健康檢查",
    "Keep existing reverse proxy and certificate assignment unchanged": "維持既有 reverse proxy 與憑證指派不變",
    "Monitor in the readiness dashboard": "在就緒度儀表板中監控",
    "low risk": "低風險",
    "medium risk": "中風險",
    "high risk": "高風險",
    # Manual checklist and runbooks.
    "MANUAL ONLY": "僅人工",
    "NO SAVED STATE": "不儲存狀態",
    "NO EXECUTION": "不執行",
    "Required Before": "執行前需求",
    "Risk If Missing": "缺少時風險",
    "Rollback / Stop Condition": "Rollback / 停止條件",
    ...
    "Steps": "步驟",
    "Validation": "驗證",
    "Static read-only checklist library for high-risk manual operations.": "高風險人工操作的靜態唯讀檢查清單庫。",
    # Sandbox gallery and cleanup planning.
    "SANDBOX ONLY": "僅 Sandbox",
    "NO PROJECT WRITE": "不寫入專案",
    "Eligible for future cleanup": "符合未來清理條件",
    "Potential reclaimable": "可釋放空間",
    "Review after": "檢視門檻",
    "Candidate after": "候選門檻",
    "no file removal": "不刪檔",
    "no project write": "不寫入專案",
    "This page lists sandbox HTML artifacts only. It does not delete, apply, deploy, or move files into any project.": "本頁只列出 sandbox HTML 產物；不刪除、不套用、不部署，也不移動檔案到任何專案。",
    "Cleanup is not enabled. This section only estimates future candidates and reclaimable space; it does not remove or modify sandbox files.": "清理功能未啟用；此區只估算未來候選項目與可釋放空間，不會移除或修改 sandbox 檔案。",
    # Release dashboard and readiness.
    "Release & Backup Dashboard": "發佈與備份儀表板",
    "NO RESTORE": "不還原",
    "Production Identity": "Production 識別",
    "Official domain": "正式網域",
    "Git commit": "Git commit",
    "Deploy jobs": "部署 jobs",
    "NO DNS CHANGE": "不變更 DNS",
    "NO NAS CHANGE": "不變更 NAS",
    "Readiness Summary": "就緒度摘要",
    "DNS Missing": "DNS 缺失",
    "This dashboard only reads status. It does not change DNS, NAS reverse proxy, certificates, backend services, or deployment jobs.": "此儀表板只讀取狀態；不變更 DNS、NAS reverse proxy、憑證、後端服務或 deployment jobs。",
    "NO PROJECT WRITE": "不寫入專案",
    # Domain center and project detail legacy terms.
    "Domain Center / 網域管理中心": "網域中心",
    "尚未綁定 project": "尚未綁定專案",
    "上線檢查通過": "上線檢查通過",
    "Deploy staging": "部署 staging",
    "Approve production": "核准 production",
    "Health check URL（可空）": "Health check URL（可空）",
    "Retry": "重新執行",
    "Hide": "隱藏",
})
UI_TRANSLATIONS["en"].update({
    # Phase 79 P1/P2 coverage reverse mappings.
    "就緒 / 監控": "Ready / Monitor",
    "需要 SSL / 憑證": "SSL / Certificate Needed",
    "後端 / upstream 待確認": "Backend / Upstream Pending",
    "DNS 缺失 / 未來建立": "DNS Missing / Future Create",
    "高風險 / 暫勿優先變更": "High-risk / Do Not Touch First",
    "下一階段建議": "Next phase suggestion",
    "未來人工確認句草稿": "Future manual confirmation phrase draft",
    "目前狀態：就緒": "Current status: ready",
    "目前狀態：後端未設定": "Current status: backend unconfigured",
    "目前狀態：DNS 缺失": "Current status: dns missing",
    "DNS record 缺失。": "DNS record is missing.",
    "持續監控；不需要 DNS 或 NAS 變更。": "Keep monitoring. No DNS or NAS change is needed.",
    "定期 HTTP/HTTPS 健康檢查": "Periodic HTTP/HTTPS health check",
    "維持既有 reverse proxy 與憑證指派不變": "Keep existing reverse proxy and certificate assignment unchanged",
    "在就緒度儀表板中監控": "Monitor in the readiness dashboard",
    "低風險": "low risk",
    "中風險": "medium risk",
    "高風險": "high risk",
    "僅人工": "MANUAL ONLY",
    "不儲存狀態": "NO SAVED STATE",
    "不執行": "NO EXECUTION",
    "執行前需求": "Required Before",
    "缺少時風險": "Risk If Missing",
    "Rollback / 停止條件": "Rollback / Stop Condition",
    "禁止動作": "Forbidden Actions",
    "操作手冊": "Runbook",
    "目的": "Purpose",
    "前置條件": "Preconditions",
    "步驟": "Steps",
    "驗證": "Validation",
    "高風險人工操作的靜態唯讀檢查清單庫。": "Static read-only checklist library for high-risk manual operations.",
    "僅 Sandbox": "SANDBOX ONLY",
    "不寫入專案": "NO PROJECT WRITE",
    "符合未來清理條件": "Eligible for future cleanup",
    "可釋放空間": "Potential reclaimable",
    "檢視門檻": "Review after",
    "候選門檻": "Candidate after",
    "不刪檔": "no file removal",
    "本頁只列出 sandbox HTML 產物；不刪除、不套用、不部署，也不移動檔案到任何專案。": "This page lists sandbox HTML artifacts only. It does not delete, apply, deploy, or move files into any project.",
    "清理功能未啟用；此區只估算未來候選項目與可釋放空間，不會移除或修改 sandbox 檔案。": "Cleanup is not enabled. This section only estimates future candidates and reclaimable space; it does not remove or modify sandbox files.",
    "發佈與備份儀表板": "Release & Backup Dashboard",
    "不還原": "NO RESTORE",
    "Production 識別": "Production Identity",
    "正式網域": "Official domain",
    "部署 jobs": "Deploy jobs",
    "不變更 DNS": "NO DNS CHANGE",
    "不變更 NAS": "NO NAS CHANGE",
    "就緒度摘要": "Readiness Summary",
    "DNS 缺失": "DNS Missing",
    "此儀表板只讀取狀態；不變更 DNS、NAS reverse proxy、憑證、後端服務或 deployment jobs。": "This dashboard only reads status. It does not change DNS, NAS reverse proxy, certificates, backend services, or deployment jobs.",
    "Domain Center / 網域管理中心": "Domain Center",
    "尚未綁定 project": "Not bound to project",
    "尚未綁定專案": "Not bound to project",
    "上線檢查通過": "Launch checks passed",
    "部署 staging": "Deploy staging",
    "核准 production": "Approve production",
    "Health check URL（可空）": "Health check URL (optional)",
    "重新執行": "Retry",
    "隱藏": "Hide",
    "未開始": "Not started",
    "新增": "New",
